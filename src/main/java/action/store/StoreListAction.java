...
import svc.store.StoreListService;
...
public class StoreListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("StoreListAction");
		...
		StoreListService boardListService = new StoreListService();
		...
		forward.setPath("store/store_list.jsp");
